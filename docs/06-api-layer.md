...
- PR inbox 聚合
- review 提交
- LLM provider / segmentation / health check
...
- 列表查询需要提供首页卡片所需的最小信息：标题、作者、仓库、变更规模、labels、reviews 摘要
...
- health check 和正式 segmentation 必须共用同一条 provider/model 调用链
- 如果 health check 成功而正式 segmentation 仍走错路径，视为实现不完整
